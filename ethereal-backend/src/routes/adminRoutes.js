...
const { bruteForceGuard } = require('../middleware/bruteForce');
const { validate } = require('../validation/validate');
const { adminLoginSchema, shippingUpdateSchema } = require('../validation/schemas');

router.post('/api/admin/login', adminLimiter, bruteForceGuard, validate(adminLoginSchema), adminController.login);
